...
<body>
  ...
  $sql = "SELECT * FROM question WHERE username = '$username' ORDER BY created DESC ";
  ...
  if ($result->num_rows > 0)
    ...
    <div class="question_box" style="padding-left: 30px;">
      ...
      <hr id="line"><br>
      <span id="specs">time alloted is</span> &nbsp;<span id="details"><?php echo $row["duration"]; ?></span> &emsp;
