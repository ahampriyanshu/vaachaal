...
<div class="col-md-8 col-sm-6 mx-auto">
    <?php
    $sql = "SELECT * FROM question WHERE category = '$category' && language = '$language'
     && duration = '$duration' ORDER BY created DESC LIMIT $start_from, $per_page";
...
$query = "SELECT * FROM question WHERE category = '$category' && language = '$language' && duration = '$duration'";
